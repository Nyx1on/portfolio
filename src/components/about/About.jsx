            ...
            <div className="row about-wrapper">
              ...
              <div className="col-md-6 col-sm-12">
                <div className="about-wrapper__info load-hidden">
                  ...
                  <p className="about-wrapper__info-text">
                    I am also an active open source contributor.I believe that
                    open source software plays a crucial role in driving
                    innovation and empowering individuals and communities around
                    the world.
                  </p>
